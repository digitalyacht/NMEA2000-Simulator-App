...
The NMEA 2000 specification Appendix B details the exact format of NMEA 2000 PGNs and this is available to purchase from the [NMEA Organisation](https://www.nmea.org/). A summary document (pdf) that details the PGN numbers and fields is included in the repo to help get you started.

Also included in this repo is an example PGN Transmission List JSON file that you can load in to the iKreate App, with some pre-configured PGNs. In addition, an example LOG file is provided so you can test the Replay feature of iKreate. 
